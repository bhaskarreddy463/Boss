            ...
            <div class="col flex-grow-1 column-picker__columns">
                <div class="row h-100">
                    <div class="col d-flex flex-column h-100 column-picker__columns-pane">
                        ...
                        <metrics-overflow-buttons></metrics-overflow-buttons>
                        @if(tags.length){
...
@Component({
  ...
  imports: [CommonModule, ButtonModule, DragDropListsComponent, DragDropListsContentDirective, IconModule, InputModule, TreeModule, DetectOverflowModule, OverflowButtonsComponent],
  providers: [
    {
